        ...
        try:
            ...
            if option:
                ...
                if option=="only add names":
                    ...
                    repeat = message_box_gui("Proceso finalizado", f"Se procesaron {len(subdirectories)} subdirectorios", "Salir", True)
                    print(repeat)
                ...
                if option=="rename subdirectories":
                    ...
                    repeat = message_box_gui("Proceso finalizado", f"Terminaste de renombrar los subdirectorios", "Salir", True)
                    print(repeat)
